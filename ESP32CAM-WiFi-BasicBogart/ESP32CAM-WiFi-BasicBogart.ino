...
// Datos de Red
const char* ssid = "INFINITUM3759";  // Pon aquí el nombre de la red a la que deseas conectarte
const char* password = "HQ2JC2hvFM";  // Escribe la contraseña de dicha red
